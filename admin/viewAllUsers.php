        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php 
                    ...
                    <a href="pendingUsers.php">Pending Requests</a>
                    <div class="table-responsive">
                        <table id="table" class="table table-striped">
                            ...
                            <tbody>
                             ...
                             // $clubID = $_SESSION['uID'];
                                 $sql = "SELECT * FROM `tbl_users` WHERE `user_status` = 'A' AND `user_type` = 'U' ORDER BY `user_id` DESC";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="deleteUser.php?userID=<?php echo $row['user_id'];?>">Delete</a>
                                    </td>
                                </tr>
                                <?php
                                          $srno++;
