            ...
            <div id="content">
                ...
                ?>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $sql = "SELECT * FROM `tbl_blogs` WHERE `blog_status` = 'P' ORDER BY `blog_id` DESC ";
                                ...
                                <tr>
                                    <td><?php echo $srno;  ?></td>
                                    <td> <img src="<?php echo $row['blog_image'];  ?>" width="50px" alt=""></td>
                                    ...
                                    <td><?php echo getUserName($row['blog_postedBy']);  ?></td>
                                    <td><a href="blogDetails.php?blogID=<?php echo $row['blog_id']; ?>"
                                            class="btn btn-sm btn-info">Review</a></td>
                                    <td>
