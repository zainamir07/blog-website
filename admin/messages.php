        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="readMessages.php">Mark As Read Messages</a>
                    <hr>
                    <div class="container">
                        <?php
                        $sql = "SELECT * FROM `tbl_contact` WHERE `contact_status` = 'NR'  ORDER BY `contact_id` DESC  ";
                        ...
                        <div class="card mt-2 mb-4" >
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <a href="deleteMessage.php?readMSG=<?php echo $row['contact_id']; ?>" class="btn btn-primary">Mark As Read</a>
