        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php 
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Pending Comments</h1>
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-striped">
                            ...
                            <tbody>
                             ...
                             // $clubID = $_SESSION['uID'];
                                 $sql = "SELECT * FROM `tbl_comments` WHERE `com_status` = 'P' ORDER BY `com_id` DESC";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="actionComments.php?approveID=<?php echo $row['com_id']; ?>">Approve</a>
